...
final class PAT_Product_Tabs {
    ...
    public function render_woocommerce_notice(): void {
        ...
        echo esc_html__('PAT Product Tabs requires WooCommerce to be active. The plugin is loaded, but tab fields and frontend tabs are disabled until WooCommerce is available.', 'pat-product-tabs');
        echo '</p></div>';
    }
